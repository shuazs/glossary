...
/**
 * A treemap that has a word for the key and an array list of word juice for the
 * value
 * 
...
public class Glossary {
    ...
    /**
     * I use a TreeMap where each word is the key
     * Every word has an arraylist of WordJuice(pos def)
     * I chose this DS so we would have O(h) lookup and words are kept in
     * lexographic order
     */
